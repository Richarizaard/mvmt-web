  ...
  return (
    <nav className="hidden md:flex w-full justify-between text-base font-semibold">
      <div className="flex justify-start gap-16 items-center">
        ...
        <Link to={'/ministries'} className="hover:text-sky-500">Ministries</Link>
        <Link to={'/sermons'} className="hover:text-sky-500">Sermons</Link>
        <Link to={'/events'} className="hover:text-sky-500">Events</Link>
        <Link to={'/about-us'} className="hover:text-sky-500">About us</Link>
      </div>
